...
const Biography = Object.create(Book, {
  title: { value: "Загальна Біографія" },
  author: { value: "Біограф" },
  pages: { value: 200 },
});
...
const Media = {
  ...
  play() {
    console.log(
      "Зараз відтворюється медіа у форматі <format> з тривалістю <length> секунд"
    );
  },
};
/*
